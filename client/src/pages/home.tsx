  ...
  return (
    <div className="bg-gradient-to-b from-gray-50 to-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            ...
            <div className="flex flex-col justify-center">
              <p className="text-sm sm:text-lg text-gray-700 mb-6 sm:mb-8 leading-relaxed">
                BuyBack Guarantee (BBG) is a plan that locks the future resale
                value of your phone or laptop at the time of purchase. Instead
                of losing money to fast depreciation, BBG secures up to 70% of
                your device's price upfront. When it's time to upgrade, you get
                instant cash to your bank or UPI after a simple quality check.
                BBG makes owning and upgrading your device smarter, safer, and
                worry-free.
              </p>
              ...
              <p className="text-sm sm:text-lg text-gray-700 mb-6 sm:mb-8 leading-relaxed">
                With BuyBack Guarantee, secure up to 70% resale value for your
                mobile or laptop. Fixed upfront, hassle-free, and ready to
                redeem whenever you upgrade. Trusted by thousands across India.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4 sm:space-y-6">
          ...
          <div className="bg-xtra-primary rounded-2xl py-4 sm:py-8 px-4 sm:px-8 text-center">
            <h3 className="text-base sm:text-2xl lg:text-3xl font-bold text-white leading-relaxed">
              Your device starts losing value the moment you
              <br />
      ...
      <section
        ...
        style={{ backgroundColor: "rgba(117, 157, 245, 0.27)" }}
      >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 justify-items-center">
            ...
            <div className="relative w-full max-w-xs">
              <div className="rounded-2xl shadow-xl overflow-hidden relative z-10 bg-gradient-to-b from-[#4A90E2] to-[#1E3A8A]">
                ...
                <div
                  className="p-4 sm:p-6 pb-10 sm:pb-14 text-white text-center"
                  style={{ textShadow: "0 2px 4px rgba(0,0,0,0.3)" }}
                >
                ...
                <div
                  className="p-4 sm:p-6 pt-8 sm:pt-14 mt-4 sm:mt-4"
                ...
                >
                  <ul className="space-y-2 sm:space-y-3 text-white">
                    <li className="flex items-center">
                      <span className="text-white mr-2 sm:mr-3">•</span>
                      <span className="text-xs sm:text-sm">
                        Free Auction Service → 10-20% higher resale than market
                      </span>
                    </li>
                    <li className="flex items-center">
                      <span className="text-white mr-2 sm:mr-3">•</span>
                      <span className="text-xs sm:text-sm">
                        1 Free Device Repair (service charges waived, parts
                        chargeable)
                      </span>
                    </li>
                    <li className="flex items-center">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative">
            <Link href="/acer" className="block">
              <div
                className="rounded-2xl px-8 py-6 text-white shadow-xl overflow-hidden relative cursor-pointer transition-transform hover:scale-105"
                style={{
                  background:
                    "linear-gradient(180deg, #4A90E2 0%, #1E3A8A 100%)",
                }}
              >
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-xs font-medium whitespace-nowrap">
                        Same assured buyback protection
                      </span>
                    </div>
                    <div className="flex items-center gap-1.5">
                      <CheckCircle className="w-3.5 h-3.5 text-green-400 flex-shrink-0" />
          ...
          <div className="text-center">
            ...
            <div className="mb-8 sm:mb-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8">
                ...
                <div className="bg-xtra-primary text-white px-4 sm:px-8 py-3 sm:py-5 rounded-lg">
                  <p className="font-medium text-xs sm:text-lg">
                    Trusted brand - already chosen by thousands across the
                    country
                  </p>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                <div className="bg-xtra-primary text-white px-4 sm:px-8 py-3 sm:py-5 rounded-lg">
                  <p className="font-medium text-xs sm:text-lg">
                    Free Auction Service - get 10-20% higher resale value than
                    market
                  </p>
                </div>
                <div className="bg-xtra-primary text-white px-4 sm:px-8 py-3 sm:py-5 rounded-lg">
              ...
              <div className="bg-white rounded-xl shadow-xl overflow-hidden">
                <div className="bg-gradient-to-r from-xtra-primary to-xtra-primary/80 text-white px-4 sm:px-6 py-4 sm:py-6">
                  ...
                  <p className="text-white/90 mt-1 sm:mt-2 text-xs sm:text-base">
                    BBG claim values based on device age
                  </p>
                </div>
                <div className="p-6">
                  {(() => {
                      ...
                      return (
                        <div className="py-12 text-center">
                          ...
                          <p className="text-gray-500">
                            No mobile device slabs available
                          </p>
                        </div>
                      );
                    }
                    ...
                    activeMobileSlabs.forEach((slab: any) => {
                      ...
                      if (!ageRanges[ageKey]) {
                        ...
                        ageRanges[ageKey].percentage = Math.max(
                          ageRanges[ageKey].percentage,
                          slab.percentage,
                        );
                      }
                    });
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-4">
                        {sortedAgeRanges.map(([ageKey, ageData]) => {
                          ...
                          return (
                            <div
                              key={ageKey}
                              className={`${bgColor} ${borderColor} border-2 rounded-xl p-4 text-center hover:shadow-md transition-all duration-200 hover:scale-105`}
                            >
                              <div className="text-xs font-medium text-gray-600 mb-2">
                                {ageData.minMonths}-{ageData.maxMonths} months
                              </div>
                              <div
                                className={`text-2xl font-bold ${textColor} mb-1`}
                              >
                                {ageData.percentage}%
                              </div>
                    ...
                    if (activeLaptopSlabs.length === 0) {
                      return (
                        <div className="py-12 text-center">
                          ...
                          <p className="text-gray-500">
                            No laptop device slabs available
                          </p>
                        </div>
                      );
                    }
            ...
            <div className="bg-gray-50 px-4 sm:px-6 py-4">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <p className="text-xs sm:text-sm text-gray-600">
                  All percentages are of invoice value for your devices in
                  functional and fair condition. Your slabs are locked as per
                  your purchase date/time and mapped to your unique BBG Voucher.
                </p>
                <div className="flex flex-col sm:flex-row gap-2">
                  <Link href="/buy-bbg">
                    <Button
                      size="sm"
                      className="w-full sm:w-auto bg-xtra-primary hover:bg-xtra-primary/90 text-white"
                    >
                      Buy
                    </Button>
                  </Link>
                  <Link href="/claim-bbg">
                    <Button
                      size="sm"
                      variant="outline"
                      className="w-full sm:w-auto border-xtra-primary text-xtra-primary hover:bg-xtra-primary/5"
                    >
                      Claim
                    </Button>
                  </Link>
