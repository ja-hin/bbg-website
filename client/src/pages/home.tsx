      ...
      <section className="bg-white py-8 sm:py-12 lg:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            {/* BBG Column */}
            <div>
              <h3 className="text-center font-black text-blue-700 mb-6" style={{color: '#1F4B88', fontSize: '2.4rem', lineHeight: '2'}}>
                BUY BACK GUARANTEE
              </h3>
            ...
            {/* Extend+ Column */}
            <div>
              <h3 className="text-center font-black text-blue-700 mb-6" style={{color: '#245AA3', fontSize: '2.4rem', lineHeight: '2'}}>
                EXTEND+
              </h3>
              <div className="space-y-4">
                <div className="relative p-4 sm:p-6 rounded-2xl text-white overflow-hidden bg-cover bg-center" style={{backgroundImage: `url('${planWorksBackgroundImg}')`, backgroundSize: 'cover', backgroundPosition: 'center'}}>
