                ...
                <Table>
                  <TableHeader>
                    <TableRow className="bg-gray-50">
                      <TableHead className="font-bold text-gray-700">Device Details</TableHead>
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="font-mono text-[10px] text-gray-600 mt-0.5">
                                  {order.deviceType?.toLowerCase() === 'laptop' ? 'Serial No.' : 'IMEI'}: {isAutoGeneratedSerial(order.serialNumber) ? "-" : order.serialNumber}
                                </p>
                              </div>
                            </div>
                          </TableCell>
                          <TableCell>
                            <span className="font-mono text-sm text-[#254696] bg-blue-50 px-2 py-1 rounded">
                              {order.voucherCode}
                            </span>
                          </TableCell>
                          <TableCell>
