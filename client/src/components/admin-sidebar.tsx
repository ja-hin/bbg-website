...
export function AdminSidebar({ className }: AdminSidebarProps) {
  ...
  const defaultMenuItems = [
    ...
    { id: "special-codes", label: "Special Codes Management", href: "/admin/special-codes", icon: "Tags", order: 9.75, type: "item", parentId: null },
    ...
    { id: "plans", label: "Plans Management", href: "/admin/plans", icon: "Package", order: 9.9, type: "item", parentId: null },
  ...
  return (
    <div className={cn("flex h-screen w-64 flex-col bg-slate-900 text-white overflow-hidden", className)}>
      {/* Header */}
