        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 flex-1 max-w-3xl">
              {/* Mobile BBG Card */}
              <div className="rounded-3xl p-10 sm:p-12 text-center text-white" style={{backgroundColor: '#3d4d63'}}>
                <h3 className="text-xl sm:text-3xl font-bold mb-4" style={{textShadow: '0 2px 4px rgba(0, 0, 0, 0.5)'}}>Mobile BBG</h3>
                <div className="text-4xl sm:text-6xl font-bold mb-3" style={{textShadow: '0 2px 4px rgba(0, 0, 0, 0.5)'}}>₹299</div>
              ...
              {/* Laptop BBG Card */}
              <div className="rounded-3xl p-10 sm:p-12 text-center text-white" style={{backgroundColor: '#0066ff'}}>
                <h3 className="text-xl sm:text-3xl font-bold mb-4" style={{textShadow: '0 2px 4px rgba(0, 0, 0, 0.5)'}}>Laptop BBG</h3>
                <div className="text-4xl sm:text-6xl font-bold mb-3" style={{textShadow: '0 2px 4px rgba(0, 0, 0, 0.5)'}}>₹499</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 flex-1 max-w-3xl">
              ...
              <div className="rounded-3xl p-10 sm:p-12 text-center text-white" style={{backgroundColor: '#3d4d63'}}>
                <h3 className="text-xl sm:text-3xl font-bold mb-4" style={{textShadow: '0 2px 4px rgba(0, 0, 0, 0.5)'}}>Mobile Extend+</h3>
                <div className="text-4xl sm:text-6xl font-bold mb-3" style={{textShadow: '0 2px 4px rgba(0, 0, 0, 0.5)'}}>₹299</div>
                <p className="text-sm sm:text-base mb-8" style={{color: '#b0bcc8', textShadow: '0 2px 4px rgba(0, 0, 0, 0.5)'}}>
                  (inclusive of GST)
                </p>
