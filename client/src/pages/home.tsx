...
import pricingLaptopHeader from "@assets/pricing_laptop_header.png";
import pricingMobileHeader from "@assets/pricing_mobile_header.png";
          ...
          <div className="grid gap-6 sm:gap-8 lg:gap-10 items-stretch [grid-template-columns:repeat(auto-fit,minmax(320px,1fr))]">
            ...
            {pricingView === "laptop" && (
              <>
                {/* Laptop BBG Card */}
                <div
                  className="w-full flex flex-col flip-card min-h-[480px]"
                ...
                >
                  ...
                  >
                    {/* Front Face */}
                    <div className="flip-card-front rounded-[2.5rem] overflow-hidden flex flex-col bg-[#F9FAFB] border border-gray-100 shadow-2xl">
                      {/* Header */}
                      <div
                        className="p-6 sm:p-8 text-white relative min-h-[160px] sm:min-h-[180px] flex items-center"
                        style={{ backgroundColor: "#0F172A" }}
                      >
                        <div className="flex justify-between items-center w-full z-10">
                          <div className="flex-1">
                            <h3 className="text-3xl sm:text-4xl font-black leading-none tracking-tight">
                              BuyBack
                              <br />
                              <span className="text-blue-400">Guarantee</span>
                            </h3>
                          </div>
                          <div className="absolute right-[22%] top-1/2 -translate-y-1/2 w-32 sm:w-48 opacity-80 pointer-events-none z-0">
                            <img 
                              src={pricingLaptopHeader} 
                              alt="Laptop Protection" 
                              className="w-full h-auto object-contain"
                            />
                          </div>
                          <div className="text-right flex flex-col items-end">
                            <div className="bg-[#FF6B6B] text-white text-[10px] sm:text-[11px] font-bold px-3 py-1 rounded-md mb-2 shadow-lg inline-block">
                              OFFER
                            </div>
                            <div className="flex flex-col items-end">
                              <span className="text-xl sm:text-2xl text-white/30 line-through font-medium">
                                ₹1299
                              </span>
                              <div className="text-4xl sm:text-5xl font-black text-[#FFD700] tracking-tighter">
                                {pricesLoading ? (
                      ...
                      <div className="flex-grow p-5 sm:p-8">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                          {/* Resale Value */}
                          <div className="bg-white p-5 rounded-3xl shadow-sm hover:shadow-md transition-shadow flex items-center gap-4 border border-gray-50 group">
                            <ProgressCircle percentage={70} />
                            <div>
                               <h4 className="font-bold text-base text-[#1F2937] leading-tight group-hover:text-[#254696] transition-colors">Guaranteed resale value</h4>
                               <p className="text-xs text-gray-500 leading-relaxed mt-1">Get back up to 70% value when you sell it back</p>
                            </div>
                          </div>

                          {/* Repair Service */}
                          <div className="bg-white p-5 rounded-3xl shadow-sm hover:shadow-md transition-shadow flex items-center gap-4 border border-gray-50 group">
                            <div className="w-14 h-14 sm:w-16 sm:h-16 flex-shrink-0 bg-gray-50 rounded-2xl flex items-center justify-center group-hover:bg-blue-50 transition-colors">
                              <Wrench className="w-7 h-7 sm:w-8 sm:h-8 text-gray-400 group-hover:text-[#254696] transform -rotate-45 transition-all" />
                            </div>
                            <div>
                              <h4 className="font-bold text-base text-[#1F2937] leading-tight group-hover:text-[#254696] transition-colors">Damage Repair Service</h4>
                              <p className="text-xs text-gray-500 mt-1 leading-relaxed">₹0 service cost on accidental damage repairs</p>
                            </div>
                          </div>

                          {/* Upgrade Offers */}
                          <div className="bg-white p-5 rounded-3xl shadow-sm hover:shadow-md transition-shadow flex items-center gap-4 border border-gray-50 group">
                            <div className="w-14 h-14 sm:w-16 sm:h-16 flex-shrink-0 bg-[#EFF6FF] rounded-2xl flex items-center justify-center group-hover:bg-[#254696] transition-all">
                               <Gift className="w-8 h-8 sm:w-10 sm:h-10 text-[#254696] group-hover:text-white transition-colors" />
                            </div>
                            <div>
                              <h4 className="font-bold text-base text-[#1F2937] leading-tight group-hover:text-[#254696] transition-colors">Upgrade Offers</h4>
                              <p className="text-xs text-gray-500 leading-relaxed mt-1">Exclusive deals for your next device purchase</p>
                            </div>
                          </div>

                          {/* Extended Warranty */}
                          <div className="bg-white p-5 rounded-3xl shadow-sm hover:shadow-md transition-shadow flex items-center gap-4 border border-gray-50 group">
                            <div className="w-14 h-14 sm:w-16 sm:h-16 flex-shrink-0 bg-[#EFF6FF] rounded-full flex items-center justify-center relative overflow-hidden group-hover:bg-[#254696] transition-all">
                               <Percent className="w-7 h-7 sm:w-8 sm:h-8 text-[#254696] z-10 group-hover:text-white transition-colors" />
                               <div className="absolute inset-0 border-[3px] border-dashed border-[#254696]/20 rounded-full animate-[spin_10s_linear_infinite]" />
                            </div>
                            <div>
                              <h4 className="font-bold text-base text-[#1F2937] leading-tight group-hover:text-[#254696] transition-colors">20% Off Warranty</h4>
                              <p className="text-xs text-gray-500 leading-relaxed mt-1">Save 20% on your next device extended protection</p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="mt-8 flex flex-col items-center gap-4">
                          <button
                            ...
                            className="text-[#254696] hover:text-[#1e3a8a] text-sm font-bold flex items-center gap-1 transition-colors"
                            data-testid="button-know-more-laptop-bbg"
                          >
                            View Resale Percentages <ArrowRight className="w-4 h-4" />
                          </button>
                          <button
                            onClick={scrollToForm}
                            className="w-full bg-[#0F172A] text-white font-black py-4 rounded-2xl text-xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] tracking-tight"
                            data-testid="button-explore-laptop-bbg"
                          >
                            Secure Resale Value Now
                          </button>
                        </div>
                      </div>
                    </div>
                    {/* Back Face */}
                    <div className="flip-card-back rounded-[2.5rem] overflow-hidden flex flex-col bg-white border border-gray-100 shadow-2xl">
                      <div
                      ...
                      >
                        ...
                        <p className="text-sm opacity-70">
                          Lock in your device's future price today
                        </p>
                      </div>
                      ...
                      <div className="p-8 pt-0 space-y-3">
                        <p className="text-xs text-center text-gray-400 max-w-[200px] mx-auto italic leading-relaxed">
                          * Percentage of original purchase price
                        </p>
                        <button
                          onClick={() => setLaptopBBGFlipped(false)}
                          className="w-full text-center font-bold py-3 rounded-xl text-sm transition-all hover:bg-gray-50 border border-gray-100"
                          style={{ color: "#254696" }}
                ...
                >
                  ...
                  >
                    ...
                    <div className="flip-card-front rounded-[2.5rem] overflow-hidden flex flex-col bg-[#F9FAFB] border border-gray-100 shadow-2xl">
                      ...
                      <div
                        className="p-6 sm:p-8 text-white relative min-h-[160px] sm:min-h-[180px] flex items-center"
                        style={{ background: "linear-gradient(135deg, #254696, #1e3a8a)" }}
                      >
                        <div className="flex justify-between items-center w-full z-10">
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-2">
                               <ShieldCheck className="w-6 h-6 text-blue-300" />
                               <span className="text-xs font-bold uppercase tracking-widest text-blue-200">Premium Protection</span>
                            </div>
                            <h3 className="text-3xl sm:text-4xl font-black leading-none tracking-tight">
                              Extend<span className="text-blue-300">+</span>
                            </h3>
                            <p className="text-xs text-blue-100/60 mt-2 font-medium">For devices older than 6 months</p>
                          </div>
                      ...
                      <div className="flex-grow p-5 sm:p-8">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                          {/* Doorstep Auction */}
                          <div className="bg-white p-5 rounded-3xl shadow-sm hover:shadow-md transition-shadow flex items-center gap-4 border border-gray-50 group">
                            <div className="w-14 h-14 sm:w-16 sm:h-16 flex-shrink-0 bg-[#FFFBEB] rounded-2xl flex items-center justify-center group-hover:bg-[#F59E0B] transition-all">
                               <Gavel className="w-7 h-7 sm:w-8 sm:h-8 text-[#F59E0B] group-hover:text-white transition-colors" />
                            </div>
                            <div>
                               <h4 className="font-bold text-base text-[#1F2937] leading-tight group-hover:text-[#254696] transition-colors">Doorstep Auction</h4>
                               <p className="text-xs text-gray-500 leading-relaxed mt-1">Free service to get best market resale value</p>
                            </div>
                          </div>
                          ...
                          <div className="bg-white p-5 rounded-3xl shadow-sm hover:shadow-md transition-shadow flex items-center gap-4 border border-gray-50 group">
                            <div className="w-14 h-14 sm:w-16 sm:h-16 flex-shrink-0 bg-gray-50 rounded-2xl flex items-center justify-center group-hover:bg-blue-50 transition-colors">
                              <Wrench className="w-7 h-7 sm:w-8 sm:h-8 text-gray-400 group-hover:text-[#254696] transition-all" />
                            </div>
                            <div>
                              <h4 className="font-bold text-base text-[#1F2937] leading-tight group-hover:text-[#254696] transition-colors">1-Year Repair</h4>
                              <p className="text-xs text-gray-500 mt-1 leading-relaxed">Begins after your brand warranty ends</p>
                            </div>
                          </div>
                          ...
                          <div className="bg-white p-5 rounded-3xl shadow-sm hover:shadow-md transition-shadow flex items-center gap-4 border border-gray-50 group">
                            ...
                            <div>
                              <h4 className="font-bold text-base text-[#1F2937] leading-tight group-hover:text-[#254696] transition-colors">20% Off Warranty</h4>
                              <p className="text-xs text-gray-500 leading-relaxed mt-1">Save on protection for your next purchase</p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="mt-8 flex flex-col items-center gap-4">
                          ...
                          >
                            How the Auction Works <ArrowRight className="w-4 h-4" />
                          </button>
                          <button
                            onClick={scrollToForm}
                            className="w-full bg-[#254696] text-white font-black py-4 rounded-2xl text-xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] tracking-tight"
                    ...
                    <div className="flip-card-back rounded-[2.5rem] overflow-hidden flex flex-col bg-white border border-gray-100 shadow-2xl">
                      ...
                      >
                        ...
                        <p className="text-sm opacity-70">
                          Maximized value, zero hassle
                        </p>
                      </div>
                      <div className="flex-grow p-8 flex flex-col justify-center space-y-6">
                        <div className="space-y-4">
                           <div className="flex gap-4">
                              <div className="flex-shrink-0 w-8 h-8 rounded-full bg-blue-50 text-[#254696] flex items-center justify-center font-bold text-sm">1</div>
                              <p className="text-sm text-gray-600 font-medium leading-relaxed">100+ verified buyers compete for your device in real-time.</p>
                           </div>
                           <div className="flex gap-4">
                              <div className="flex-shrink-0 w-8 h-8 rounded-full bg-blue-50 text-[#254696] flex items-center justify-center font-bold text-sm">2</div>
                              <p className="text-sm text-gray-600 font-medium leading-relaxed">Free doorstep pickup and instant payment at the best market price.</p>
                           </div>
                           <div className="flex gap-4">
                              <div className="flex-shrink-0 w-8 h-8 rounded-full bg-blue-50 text-[#254696] flex items-center justify-center font-bold text-sm">3</div>
                              <p className="text-sm text-gray-600 font-medium leading-relaxed">Secure data wiping ensured before the device leaves your home.</p>
                           </div>
                        </div>
                      </div>
                      <div className="p-8 pt-0 space-y-3">
