      ...
      <section className="bg-white" style={{paddingTop: '0.5rem', paddingBottom: '0.5rem'}}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center gap-4 sm:gap-6 lg:gap-8">
            <div className="flex-1 h-1" style={{backgroundColor: '#303e58'}}></div>
            <h2 className="text-center whitespace-nowrap" style={{fontSize: '50px', color: '#303e58', fontFamily: 'Poppins, sans-serif', fontWeight: '900'}} data-testid="heading-which-plan">
