          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="relative p-4 sm:p-6 rounded-2xl text-white overflow-hidden bg-cover bg-center" style={{backgroundImage: `url(${planWorksBackgroundImg})`}}>
                  <div className="absolute inset-0" style={{backgroundColor: '#1F4B88', opacity: 0.7}}></div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="relative p-4 sm:p-6 rounded-2xl text-white overflow-hidden bg-cover bg-center" style={{backgroundImage: `url(${planWorksBackgroundImg})`}}>
                  <div className="absolute inset-0" style={{backgroundColor: '#245AA3', opacity: 0.7}}></div>
                  <p className="font-semibold text-base sm:text-lg relative z-10">
