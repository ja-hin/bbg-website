      ...
      <section className="bg-white py-8 sm:py-12 lg:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
            {/* BBG Card */}
            <div style={{borderRadius: '35px', padding: '1px', background: 'radial-gradient(circle at 50% 50%, #c6d8ff, #0f5eb4, #303e59)', display: 'flex', flexDirection: 'column', height: '100%'}}>
              <div className="p-4 sm:p-6 bg-white flex-1" style={{borderRadius: '35px', display: 'flex', flexDirection: 'column'}}>
