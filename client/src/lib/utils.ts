...
// Utility function to check if a serial number is auto-generated
export function isAutoGeneratedSerial(serialNumber: string | undefined | null): boolean {
  if (!serialNumber) return false;
  return serialNumber.startsWith('AUTO_');
}

// Utility function to display serial number (hide auto-generated ones for customers)
export function displaySerialNumber(serialNumber: string | undefined | null, hideAutoGenerated: boolean = true): string {
  if (!serialNumber) return 'Not provided';
  
  if (hideAutoGenerated && isAutoGeneratedSerial(serialNumber)) {
    return 'Will be updated after device registration';
  }
