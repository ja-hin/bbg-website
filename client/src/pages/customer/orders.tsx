...
import { Package, Upload, Clock, CheckCircle, Search, ChevronLeft, ChevronRight, Smartphone, Laptop, FileText, MoreVertical, Filter, ArrowUpDown } from 'lucide-react';
            ...
            <>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
                {paginatedOrders.map((order) => {
                  ...
                  return (
                    <Card key={order.id} className={`overflow-hidden border transition-all hover:shadow-md ${needsInvoice ? 'bg-orange-50/30 border-orange-100' : 'bg-white border-gray-100'}`}>
                      <div className="p-4 space-y-4">
                        ...
                        <div className="flex justify-between items-start">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-500">{order.modelName}</p>
                            </div>
                          </div>
                          <DropdownMenu>
                        ...
                        <div className="grid grid-cols-2 gap-y-3 gap-x-4 text-sm">
                          <div>
                            <p className="text-gray-500 text-xs mb-1">Serial / IMEI</p>
                            <p className="font-mono text-gray-700 truncate">
                              {isAutoGeneratedSerial(order.serialNumber) ? "-" : order.serialNumber}
                            </p>
                          </div>
                          <div>
                            <p className="text-gray-500 text-xs mb-1">Voucher Code</p>
                            <span className="font-mono text-[#254696] bg-blue-50 px-2 py-0.5 rounded text-xs">
                              {order.voucherCode}
                            </span>
                          </div>
                          <div>
                            <p className="text-gray-500 text-xs mb-1">Purchase Date</p>
                            <p className="text-gray-700">{formatDate(order.dateOfPurchase)}</p>
                          </div>
                          <div>
                            <p className="text-gray-500 text-xs mb-1">Invoice Value</p>
                            <p className="font-bold text-gray-900">₹{order.invoiceValue?.toLocaleString()}</p>
                          </div>
                        </div>
                        ...
                        <div className="pt-3 border-t border-gray-100 flex flex-wrap items-center justify-between gap-2">
                          <div className="flex items-center gap-2">
                            ...
                            {needsInvoice ? (
                              ...
                              <Badge variant="outline" className="bg-green-50 text-green-700 border-green-200 text-[10px] px-1.5 py-0 flex items-center gap-1">
                                <FileText className="h-2.5 w-2.5" /> Invoice
                              </Badge>
                            )}
                          </div>
                          <Badge variant="secondary" className="text-xs font-normal text-gray-500 bg-gray-100">
                            {sourceDisplay}
                          </Badge>
                        </div>
                      </div>
