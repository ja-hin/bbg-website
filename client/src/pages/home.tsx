  ...
  return (
    <div className="bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="py-12 sm:py-16 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative">
            <div className="rounded-2xl px-8 py-6 text-white shadow-xl overflow-hidden relative border-8" style={{background: 'linear-gradient(180deg, #4A90E2 0%, #1E3A8A 100%)', borderColor: '#254595'}}>
